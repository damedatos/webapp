    ...
    return(<div className="navbar">
        ...
        <div className="navbar-end">
            {user ? <div className="dropdown dropdown-hover">
                    <div tabIndex={0} role="button" className="btn btn-circle text-xl font-extrabold">{user.id}</div>
                    <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box gap-2">
                        ...
                        <li role="button" className="btn" onClick={async () => await supabaseClient.auth.signOut()}>Salir</li>
                    </ul>
